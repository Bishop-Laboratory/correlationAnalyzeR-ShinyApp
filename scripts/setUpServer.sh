...
R -e "install.packages(c('shinyjs','shiny','shinymanager','shinydashboard','shinythemes','devtools','shinyWidgets','plotly','heatmaply','ggpubr','ggplot2','Rtsne','ggrepel','ggplot2', 'DT', 'gplots', 'data.table', 'BiocManager', 'DBI', 'RMySQL','pheatmap','SuperExactTest', 'pryr', 'pool', 'shinyBS', 'future', 'promises', 'benchmarkme'), repos = 'http://cran.rstudio.com/')"
